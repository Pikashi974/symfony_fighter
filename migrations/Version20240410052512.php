 ...
 */
final class Version20240410052512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE champion (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, pv INT NOT NULL, power INT NOT NULL, PRIMARY KEY(id))  ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id))  ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_champion (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, champion_id INT NOT NULL, UNIQUE INDEX UNIQ_A5CE9AB4A76ED395 (user_id), INDEX IDX_A5CE9AB4FA7FD7EB (champion_id), PRIMARY KEY(id))  ENGINE = InnoDB');
